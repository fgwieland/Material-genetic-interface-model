                ...
                for jt = 1:length(dr_times)
                    ...
                    for jc = jcs
                        ...
                        if(qDR)
                            ...
                            [t_red, its] = unique(t);
                            t = linspace(min(t)*0.7,max(t),ar.config.nFinePoints)';
                        ...
                        %% Custom version of arPlot2
                        xLabel = 'log_{10}(BSA-fluorescein concentration [nM])';
                        yLabel = {'SEAP activity [U/L]'};
                        

                        %% Continue traditional version of arPlot2
                        ...
                        %% Custom addition show offset
                        hold on
                        plot(xlim(), [2.53068828 2.53068828], 'b--')
...
%                     delete(g);
                ...
                if(saveToFile)
                    ...
                    [ ar.model(jm).plot(jplot).(field), ...
                        ...
                        arSaveFigureCustom(h, ar.model(jm).plot(jplot).name, pfad);
                end
            else
